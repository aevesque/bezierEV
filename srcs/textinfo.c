...
void	displayPointInfo(Context *context, TermGL termGL)
{
	...
	sprintf(point_info, "Current point : %01d (%.4f, %.4f)", context->current_point, context->control_points[context->current_point].x, context->control_points[context->current_point].y);
